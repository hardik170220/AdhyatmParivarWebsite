...
const DikshitDetailsForm = ({ formData, updateFormData, nextStep, prevStep, handleRegister }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Format the data as requested structure
      const formattedData = formatDataAsArray(values);
      
      // Log the formatted data for debugging
      console.log("Form data in requested format:", formattedData);
      
      // Update parent form data with formatted structure
      ...
      // Pass the formatted data to the register function
  ...
  const handlePrevStep = () => {
    ...
    // Format as requested structure and send to parent
    const formattedData = formatDataAsArray(currentValues);
    updateFormData(formattedData);
