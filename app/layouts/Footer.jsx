  ...
  return (
    <footer className="bg-purple mt-10 font-Teko text-gray-600 p-6 text-center relative   antialiased">
      ...
      <div className="flex text-base  justify-between flex-col md:flex-row">
        ...
        <div>
          <h3 className="font-bold mb-2">::: अहमदाबाद :::</h3>
          <p>अध्यात्म परिवार,तृतीय तल </p>
          <p>श्री शांति जिन जैन संघ</p>
          <p>श्री शांति जिन संयम मार्ग</p>
          <p>पशु अस्पताल के बाजू में</p>
          <p>मादलपुर, पालडी, अहमदाबाद 380007</p>
          <p className="mt-2">M. 72270 70407</p>
        </div>
      </div>
