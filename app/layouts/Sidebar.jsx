...
//       className={`main-sidebar ${isSidebarHide ? 'lg:w-0' : 'lg:w-64'} transition-width duration-500 ease-in-out h-[calc(100vh-65px)] pb-6 pt-11  text-white shadow-[rgba(0,0,15,0.1)_1px_0px_0px_0px] overflow-y-scroll custom-scrollbar border-gray-500 ${className}`}
//     >
//       <div>
//         <div className="mb-2">
