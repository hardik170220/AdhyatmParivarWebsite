...
const ImageCarousel = () => {
  ...
  return (
    ...
    >
      {/* Slides */}
      <div className="relative h-full bg-[#F0E9D7] w-full flex items-center justify-center">
        {images.map((image, index) => (
          ...
          >
            <div className="relative h-full  border-4 border-golden/60 shadow-2xl max-h-[28rem] w-auto max-w-full overflow-hidden">
              <img
                src={image}
                alt={`Slide ${index + 1}`}
    ...
    <div className="min-h-screen w-full py-0 md:py-8 bg-gray-100">
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 bg-[#F0E9D7] gap-12 sm:gap-0 lg:grid-cols-2">
            {/* Image Section */}
