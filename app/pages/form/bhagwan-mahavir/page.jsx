              ...
              <Form form={form} layout="vertical" onFinish={onFinish}>
                <Row gutter={16}>
                  ...
                  <Col xs={24} md={12}>
                    ...
                    >
                      <Input className="rounded-md font-Anek" placeholder="નામ" />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row gutter={16}>
                  <Col xs={24} md={12}>
                    ...
                    >
                      <Input className="rounded-md font-Anek" placeholder="અટક" />
                    </Form.Item>
                  </Col>
                  <Col xs={24} md={12}>
                    <Form.Item
                ...
                <Row gutter={16}>
                  <Col xs={24} md={12}>
                    ...
                    >
                      <Select placeholder="રાજ્ય" className="rounded-md font-Anek">
                        {states.map((state) => (
                  ...
                  <Col xs={24} md={12}>
                    ...
                    >
                      <Input className="rounded-md font-Anek" placeholder="શહેર" />
                    </Form.Item>
                  </Col>
                </Row>
