  ...
  return (
    <div className="pt-16 px-5 sm:px-10">
      <h1 className="font-bold flex items-center gap-2 border-b-2 border-golden font-Teko mb-8 text-xl text-gray-600 text-start">
        इवेंट्स के लिए रजिस्ट्रेशन फॉर्म 
        <MdOutlineKeyboardDoubleArrowRight  size={24} className="arrow" />
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8  font-Karma justify-items-center">
        <div className="flex flex-col items-center justify-center w-full group max-w-[500px]">
          <div className="relative w-full">
            <div className="relative font-Anek overflow-hidden w-full">
              <img
