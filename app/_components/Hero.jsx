        ...
        <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col-reverse items-center">
          <div className="relative lg:flex-grow md:w-[104%] lg:px-12 md:p-8 flex flex-col md:items-start md:text-left mt-16 md:mt-0 items-center">
            ...
            <p className="mb-2 font-Karma leading-relaxed">
             अध्यात्म परिवार एक समर्पित संगठन है, जो धार्मिक एवं आध्यात्मिक उन्नति के मार्ग पर चलने में सबको सहायक बनता है।
 
इस संगठन द्वारा जैनशासन की आराधना, प्रभावना और धार्मिक परंपराओं की रक्षा जैसे विभिन्न कार्यों का संचालन किया जाता है।
 
इसके साथ ही, विशेष आयोजन और प्रवचन कार्यक्रमों के माध्यम से सर्वत्र आध्यात्मिक जागरूकता और समर्पण की भावना को प्रोत्साहित किया जाता है।
            </p>
